...
//                      class RossiBigInt
// 
//  Copyright (C) 1999-2019  Alex Vinokur
//                           class BigInt 
...
void BigInt::showVersion(std::ostream& o_stream)
{
	...
	oss	<< std::endl
		...
		<< std::endl
		<< "Copyright (C) 1999-2019  Alex Vinokur - class BigInt, class BigInt::BaseBigInt, class BigInt::Vin, upgrading class BigInt::Rossi, class BigInt::Run, class BigInt::Test, class BigInt::TestVin, class BigInt::TestRossi, class BigInt::PerformanceTestVin, class BigInt::PerformanceTestRossi"
		<< std::endl
...
{
static std::map<char, std::size_t> ms_hex2dec (array2map(s_hex2dec));

    ASSERTION (!ms_hex2dec.empty());
	ASSERTION (m_units.empty());
...
{
static const BigInt::Rossi RossiOne = BigInt::Rossi (1);
...
BigInt::Rossi BigInt::Rossi::operator-(const BigInt::Rossi& i_arg)
{
static const BigInt::Rossi RossiZero = BigInt::Rossi (0);
...
static const BigInt::Rossi RossiZero = BigInt::Rossi (0);
static const BigInt::Rossi RossiOne = BigInt::Rossi (1);
static const BigInt::Rossi RossiTwo = BigInt::Rossi (2);
...
{
static const BigInt::Vin VinZero = BigInt::Vin (0);
...
const BigInt::Rossi RossiZero = BigInt::Rossi (0);
